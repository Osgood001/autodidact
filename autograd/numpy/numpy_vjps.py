...
defvjp(anp.tan,    lambda g, ans, x: g * anp.cos(x) ** -2)
defvjp(anp.arcsin, lambda g, ans, x: g / anp.sqrt(1 - x**2))
defvjp(anp.arccos, lambda g, ans, x: -g / anp.sqrt(1 - x**2))
defvjp(anp.arctan, lambda g, ans, x: g / (1 + x**2))
